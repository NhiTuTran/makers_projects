...
def starts_with_a(arr)
  return arr.select { |element| element.start_with?("a") }
end
...
def starts_with_a_vowel(arr)
  return arr.select { |element| element.downcase.start_with?("a", "e", "i", "o", "u") }
end
...
def reverse_each_element(arr)
  return arr.map { |element| element.reverse }
end
...
def sort_by_last_letter(arr)
  return arr.sort_by { |element| element[-1] }
end
...
def greater_than_5(arr)
  return arr.select { |element| element > 5 }
end
...
def greater_than(arr, num)
  return arr.select { |element| element > num }
end
...
def words_shorter_than(arr, num)
  return arr.select { |element| element.length < num }
end
...
def all_above?(arr, num)
  return arr.all? { |element| element > num }
end
...
def where_value_below(hash, num)
  return hash.select { |key, value| value < num }
end
...
def where_key_starts_with(hash, str)
  return hash.select { |key, value| key.start_with?(str) }
end
